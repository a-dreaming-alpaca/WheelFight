# WheelFight Mega Sensor Protocol v1
...
| `DI2` | Rear-facing fence photoelectric sensor. Active low. |
...
```text
WF1,sequence,mega_millis,A0,A1,...,A13,DI0,DI1,DI2
```

A complete example frame is:

```text
WF1,42,123456,100,101,102,103,104,105,106,107,108,109,110,111,112,113,0,1,0*D1DC
```

- `WF1`: protocol and version marker.
...
- `A0` ... `A13`: raw 10-bit ADC readings in the range 0 ... 1023.
- `DI0` ... `DI2`: raw digital readings, each either 0 or 1.
...
full. Protocol v1 has no commands from the RK3588S to the Mega.
