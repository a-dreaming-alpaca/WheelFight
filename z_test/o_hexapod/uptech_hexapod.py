...
class HexApod:
    ...
    def ready(self):
        for id in range(1,21):
            self.up.CDS_SetAngle(id,512, 512)
        time.sleep(1)
    ...
    def get_robot_state(self):
        ...
        print("adc_1 = {},io0 = {}, io1 = {}".format(adc_1,io_channel_0,io_channel_1))

        # ad没有检测到障碍————静止
        if adc_1 < 180:		
            # 无障碍		 				
            if io_channel_0 == 1 and io_channel_1 == 1:				
                robot_state = 1
            # 左侧障碍
            elif io_channel_0 == 0 and io_channel_1 == 1:	      	
                robot_state = 2
            # 右侧障碍
            elif io_channel_0 == 1 and io_channel_1 == 0:		
                robot_state = 3
            else:  			    			 	        
                robot_state = 4
        # ad检测到障碍————幅度较大的动作
    ...
    def is_state_changed(self):
        robot_state_isc = self.get_robot_state()
